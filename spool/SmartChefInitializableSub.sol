...
contract SmartChefInitializableSub is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;
    SmartChefInitializable public smartChefInitializable;
    ...
    constructor(SmartChefInitializable _smartChefInitializable) {
        SMART_CHEF_FACTORY = msg.sender;
        smartChefInitializable = _smartChefInitializable;
    }
    ...
    function pendingReward(address _user) external view returns (uint256) {
        if(smartChefInitializable.lastRewardBlock() == 0) return 0;
    ...
    function _updatePool() internal {
        if(smartChefInitializable.lastRewardBlock() == 0) return;
